...
на примерах из лабораторной работы 1 и на новых примерах, демонстрирующих
обработку ошибок. Добавить в [`README.md`](README.md) список семантических проверок/ошибок, которое поддерживает ваш компилятор
...
каждой платформы: [HOWTO: генерация целевого кода](https://rserdyukov.github.io/yapis-2026/labs/codegen-howto/).
