...
## 1. Последовательность лабораторных работ { #posledovatelnost }

<a id="lab-1"></a>**Лабораторная работа 1**
...
<a id="lab-2"></a>**Лабораторная работа 2**
...
<a id="lab-3"></a>**Лабораторная работа 3**
...
<a id="lab-4"></a>**Лабораторная работа 4**
...
<a id="lab-5"></a>**Лабораторная работа 5**
Завершить написание компилятора, добавить логику генерации целевого кода для VM.
Подготовить отчёт. Схемы трансляции, инструменты и проверенный пример для
каждой платформы: [HOWTO: генерация целевого кода](codegen-howto.md).

> Одна лабораторная работа — одна ветка `task<номер>` и один Pull Request.
> Подробности в `GUIDE.md` своего репозитория.

## 2. Структура отчёта по лабораторному практикуму { #otchet }
...
## 3. Требования к разрабатываемому языку { #trebovaniya }
...
в `README.md` своего репозитория. Как учебные свойства соотносятся с реальными языками — в
