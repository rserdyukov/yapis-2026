...
в `README.md` своего репозитория.

Общие для всех вариантов требования — в разделе [Лабораторный
практикум](index.md).

## 1. Варианты свойств языка { #svoystva }
...
## 3. Варианты целевого кода { #celevoy-kod }
...
## 4. Варианты заданий { #raspredelenie }

Столбцы «1»–«9» — это свойства языка из [раздела 1](#svoystva)
в том же порядке; число в ячейке — номер подпункта. Столбец «Язык» ссылается
на [раздел 2](#yazyki), «Целевой код» — на
[раздел 3](#celevoy-kod).
